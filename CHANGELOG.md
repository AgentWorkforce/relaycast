...
- Fleet inventory reconciliation isolates stale or conflicting members, so one bad identity can no longer expire every healthy sibling on the same node and strand their inbound deliveries.
