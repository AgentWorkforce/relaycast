...
describe('AgentClient features', () => {
  ...
  describe('channels', () => {
    ...
    it('list() passes includeArchived', async () => {
      ...
      expect(url).toBe(
        'https://cast.agentrelay.com/v1/channels?include_archived=true',
      );
    });
    ...
    it('get() gets /v1/channels/:name', async () => {
      ...
      const [url] = mockFetch.mock.calls[0]!;
      expect(url).toBe('https://cast.agentrelay.com/v1/channels/dev');
    });
    ...
    it('join() posts to /v1/channels/:name/join', async () => {
      ...
      const [url, init] = mockFetch.mock.calls[0]!;
      expect(url).toBe('https://cast.agentrelay.com/v1/channels/dev/join');
      expect(init.method).toBe('POST');
    });
    ...
    it('leave() posts to /v1/channels/:name/leave', async () => {
      ...
      const [url, init] = mockFetch.mock.calls[0]!;
      expect(url).toBe('https://cast.agentrelay.com/v1/channels/dev/leave');
      expect(init.method).toBe('POST');
    });
    ...
    it('setTopic() patches /v1/channels/:name/topic', async () => {
      ...
      const [url, init] = mockFetch.mock.calls[0]!;
      expect(url).toBe('https://cast.agentrelay.com/v1/channels/dev/topic');
    ...
    it('invite() posts to /v1/channels/:name/invite', async () => {
      ...
      const [url, init] = mockFetch.mock.calls[0]!;
      expect(url).toBe('https://cast.agentrelay.com/v1/channels/dev/invite');
      expect(init.method).toBe('POST');
    ...
    it('members() gets /v1/channels/:name/members', async () => {
      ...
      const [url, init] = mockFetch.mock.calls[0]!;
      expect(url).toBe('https://cast.agentrelay.com/v1/channels/dev/members');
      expect(init.method).toBe('GET');
    });
    ...
    it('mute() posts to /v1/channels/:name/mute', async () => {
      ...
      const [url, init] = mockFetch.mock.calls[0]!;
      expect(url).toBe('https://cast.agentrelay.com/v1/channels/dev/mute');
      expect(init.method).toBe('POST');
    });
    ...
    it('unmute() posts to /v1/channels/:name/unmute', async () => {
      ...
      const [url, init] = mockFetch.mock.calls[0]!;
      expect(url).toBe('https://cast.agentrelay.com/v1/channels/dev/unmute');
      expect(init.method).toBe('POST');
    });
  });
  ...
  describe('reactions', () => {
    it('react() posts to /v1/messages/:id/reactions', async () => {
      ...
      const [url, init] = mockFetch.mock.calls[0]!;
      expect(url).toBe(
        'https://cast.agentrelay.com/v1/messages/m_1/reactions',
      );
      expect(init.method).toBe('POST');
    ...
    it('unreact() deletes /v1/messages/:id/reactions/:emoji', async () => {
      ...
      const [url, init] = mockFetch.mock.calls[0]!;
      expect(url).toBe(
        'https://cast.agentrelay.com/v1/messages/m_1/reactions/eyes',
      );
      expect(init.method).toBe('DELETE');
    });
  ...
  describe('search', () => {
    it('search() passes query to /v1/search', async () => {
      ...
      const [url] = mockFetch.mock.calls[0]!;
      expect(url).toBe(
        'https://cast.agentrelay.com/v1/search?q=deploy+error',
      );
    });
    ...
    it('search() passes opts', async () => {
      ...
      const [url] = mockFetch.mock.calls[0]!;
      expect(url).toBe(
        'https://cast.agentrelay.com/v1/search?q=err&channel=dev&from=Bot&limit=5',
      );
    });
  });
  ...
  describe('inbox', () => {
    it('inbox() gets /v1/inbox', async () => {
      ...
      const [url, init] = mockFetch.mock.calls[0]!;
      expect(url).toBe('https://cast.agentrelay.com/v1/inbox');
      expect(init.method).toBe('GET');
    });
  });
  ...
  describe('read receipts', () => {
    it('markRead() posts to /v1/messages/:id/read', async () => {
      ...
      const [url, init] = mockFetch.mock.calls[0]!;
      expect(url).toBe('https://cast.agentrelay.com/v1/messages/m_1/read');
      expect(init.method).toBe('POST');
    });
    ...
    it('readers() gets /v1/messages/:id/readers', async () => {
      ...
      const [url, init] = mockFetch.mock.calls[0]!;
      expect(url).toBe('https://cast.agentrelay.com/v1/messages/m_1/readers');
      expect(init.method).toBe('GET');
    });
    ...
    it('readStatus() strips # prefix', async () => {
      ...
      const [url] = mockFetch.mock.calls[0]!;
      expect(url).toBe(
        'https://cast.agentrelay.com/v1/channels/general/read-status',
      );
    });
  ...
  describe('files', () => {
    it('upload() posts to /v1/files/upload', async () => {
      ...
      const [url, init] = mockFetch.mock.calls[0]!;
      expect(url).toBe('https://cast.agentrelay.com/v1/files/upload');
      expect(init.method).toBe('POST');
      expect(init.body).toBe(
        JSON.stringify({
          filename: 'log.txt',
    ...
    it('complete() posts to /v1/files/:id/complete', async () => {
      ...
      const [url, init] = mockFetch.mock.calls[0]!;
      expect(url).toBe('https://cast.agentrelay.com/v1/files/f_1/complete');
      expect(init.method).toBe('POST');
    });
    ...
    it('get() gets /v1/files/:id', async () => {
      ...
      const [url, init] = mockFetch.mock.calls[0]!;
      expect(url).toBe('https://cast.agentrelay.com/v1/files/f_1');
      expect(init.method).toBe('GET');
    });
    ...
    it('list() gets /v1/files', async () => {
      ...
      const [url, init] = mockFetch.mock.calls[0]!;
      expect(url).toBe('https://cast.agentrelay.com/v1/files');
      expect(init.method).toBe('GET');
    });
    ...
    it('list() passes query params', async () => {
      ...
      const [url] = mockFetch.mock.calls[0]!;
      expect(url).toBe(
        'https://cast.agentrelay.com/v1/files?uploaded_by=Bot&limit=10',
      );
    });
