...
// TODO(issue #106): add adapter-level coverage for missing canonical IDs and last-writer-wins slug collisions where alias files are emitted.
// Keep alias helpers duplicated byte-for-byte with cataloging-agent-github until a shared internal helper is approved.
