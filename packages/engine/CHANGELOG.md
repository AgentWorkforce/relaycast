...
- `POST /v1/actions/:name/invoke` atomically claims caller-scoped idempotency keys before provider dispatch and replays the original invocation with its immutable handler identity.
