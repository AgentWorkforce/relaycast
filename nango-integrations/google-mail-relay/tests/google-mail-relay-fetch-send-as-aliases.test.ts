...
import createSync from '../syncs/fetch-send-as-aliases.js';

describe('google-mail-relay fetch-send-as-aliases tests', () => {
  const models = 'GoogleMailSendAsAlias'.split(',');

  const createTestContext = () => {
    const nangoMock = new global.vitest.NangoSyncMock({
      dirname: __dirname,
      name: "fetch-send-as-aliases",
